...
local function isexec(fname) return uv.fs_access(fname, "x") end

local function oil_err(msg)
  vim.notify("oil.nvim: " .. msg, vim.log.levels.ERROR)
end
...
vim.keymap.set("n", "<leader>ox", run_file)
